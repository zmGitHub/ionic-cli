...
var TASKS = [
  ...
  },
  {
    ...
    options: {
      ...
      '--nobuild|-i': {
        boolean: true,
        title: 'Do not run build before serve'
      }
    },
    module: './ionic/serve'
  },
  ...
  },
  {
   ...
   },
   {
    title: 'transpile',
    name: 'transpile', 
    summary: 'Transpile, compile, and combine files in your Ionic app',
    module: './ionic/transpile',
    args: {
      '<task>': '[ compile | sass ]',
    }
   },
   {
    title: 'v2',
    name: 'v2',
    summary: 'Gives simple information to get started with Ionic v2',
    module: './ionic/v2',
    disableChangePwd: true
   },
   {
