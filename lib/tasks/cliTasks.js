...
var TASKS = [
  ...
  },
  {
    ...
    args: {
      '<command>': 'build'.yellow + ', ' + 'list'.yellow + ', or ' + 'download'.yellow,
      '[options]': ''
    },
    options: {
      '--release': '(' + 'build'.yellow + ') Mark this build as a release',
      '--keystore <path>': '(' + 'build android'.yellow + ') Specify the location of your keystore file',
      '--keystore-password <password>': '(' + 'build android'.yellow + ') Specify your keystore password (exclude for prompt)',
      '--key-alias <alias>': '(' + 'build android'.yellow + ') Specify your key alias for this app',
      '--key-password <password>': '(' + 'build android'.yellow + ') Specify your key password for this app (exclude for prompt)',
      '--cert <path>': '(' + 'build ios'.yellow + ') Specify the location of your .p12 file',
      '--cert-password <password>': '(' + 'build ios'.yellow + ') Specify your certificate password (exclude for prompt)',
      '--provisioning-profile <path>': '(' + 'build ios'.yellow + ') Specify the location of your .mobileprovision file'
    },
  ...
  },
  {
   ...
   },
   {
    title: 'release',
    name: 'release',
    summary: 'Sets up build for a release by concatenating, minifying, and compressing images',
    args: {
      '<platform>': 'specify either ios or android'
    },
    options: {
      '--compressImages': {
        title: 'Compress the images in locations specified in ionic.project attribute "imagePaths". Defaults to "www/img"',
        boolean: true
      }
    },
    module: './ionic/release'
   }
];
