...
IonicDeployTask.HELP_LINE = 'Deploy an Ionic project to the Ionic Platform (requires login)';

IonicDeployTask.prototype = new IonicTask();

IonicDeployTask.prototype._printUsage = function() {
  process.stderr.write('\nUsage: ionic deploy ["note"]\n');
};

IonicDeployTask.prototype.run = function(ionic, callback) {
  ...
  login.get(ionic, function(jar) {
    ...
    zip.on('close', function() {
      ...
      var url = ionic.IONIC_DASH + ionic.IONIC_API + 'app/' + project.get('app_id') + '/deploy';
